...
// #nosec G404 code migrated from https://github.com/ethereum/go-ethereum. We probably can just use crypto/rand to generate pseudorandom byte sequences.
// We need to understand why go-ethereum made the decision not to do so.
