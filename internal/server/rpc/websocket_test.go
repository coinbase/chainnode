...
func TestClientWebsocketLargeMessage(t *testing.T) {
	var (
		srv     = NewServer(ServerParams{BatchLimitConfig: config.BatchLimitConfig{}, Scope: tally.NoopScope})
...
func TestIntegrationClientWebsocketSevered(t *testing.T) {
	if os.Getenv("TEST_TYPE") != "integration" {
		// this is an integration test.
		// a workaround since this package does not use dependency injection
		t.Skip()
	}
