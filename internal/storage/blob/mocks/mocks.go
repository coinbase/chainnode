...
// Source: github.com/coinbase/chainnode/internal/storage/blob (interfaces: BlobStorage)

// Package blobmocks is a generated GoMock package.
package blobmocks
...
func (m *MockBlobStorage) Download(arg0 context.Context, arg1 string) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (m *MockBlobStorage) Upload(arg0 context.Context, arg1 string, arg2 []byte) error {
	m.ctrl.T.Helper()
